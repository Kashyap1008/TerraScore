  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-14 bg-panel/80 backdrop-blur border-b border-panelEdge z-30 flex items-center justify-between px-4">
      ...
      <div className="flex gap-2">
        <button className="bg-transparent border border-neonGreen text-neonGreen hover:bg-neonGreen hover:text-black font-mono text-xs uppercase px-3 py-1.5 rounded-sm transition-colors">
          EXPORT
        </button>
        <button className="bg-transparent border border-neonGreen text-neonGreen hover:bg-neonGreen hover:text-black font-mono text-xs uppercase px-3 py-1.5 rounded-sm transition-colors">
